...
constexpr int ENEMY3_STRENGTH{ 172 };
constexpr int ENEMY4_STRENGTH{ 300 };
constexpr int ENEMY5_STRENGTH{ 90 };
...
bool Level3::on_start()
{
	...
	m_object.push_back(new Game_object("roof"s, ENEMY2_BASE_X, ENEMY2_BASE_Y, 130, 130));//enemy2's base, tower 1
	m_object.push_back(new Game_object("base"s, ENEMY3_BASE_X, ENEMY3_BASE_Y, 130, 130));//enemy3's base, tower 2
	m_object.push_back(new Game_object("base"s, ENEMY4_BASE_X, ENEMY4_BASE_Y, 130, 130));//enemy4's base, tower 2
	m_object.push_back(new Game_object("roof"s, ENEMY5_BASE_X, ENEMY5_BASE_Y, 130, 130));//enemy5's base, tower 2
