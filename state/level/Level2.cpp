...
constexpr int ENEMY1_BASE_Y{ 458 };
constexpr int ENEMY2_BASE_X{ 900 };
constexpr int ENEMY2_BASE_Y{ 330 };
...
bool Level2::on_start()
{
	...
	m_object.push_back(new Game_object("roof"s, ENEMY2_BASE_X, ENEMY2_BASE_Y, 130, 130));//enemy2's base, tower 2
	...
	m_enemy.push_back(new Enemy("enemy_default"s, ENEMY2_STRENGTH, ENEMY2_BASE_X+50, ENEMY2_BASE_Y+65, 80, 64, SDL_FLIP_HORIZONTAL)); enemy_count++;//enemy2
	m_exit = false;
	return true;
	return true;
}
