...
const std::string Level11::m_state_ID{ "LEVEL11"s };
...
void Level11::update()
{
	...
	if (m_player->get_strength() == 0 && frame_check_defeat()) {
		...
		game::instance()->set_level_cleared(10);
		SDL_Delay(500);
...
bool Level11::is_tower_destroyed(int start_enemy_index, int end_enemy_index)
{
...
bool Level11::frame_check_victory()
{
