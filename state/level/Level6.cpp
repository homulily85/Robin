...
constexpr int ENEMY5_STRENGTH{ 380 };
...
constexpr int ENEMY4_BASE_X{ 700 };
constexpr int ENEMY4_BASE_Y{ 0 };

constexpr int ENEMY5_BASE_X{ 900 };
constexpr int ENEMY5_BASE_Y{ 460 };

constexpr int ENEMY6_BASE_X{ 900 };
constexpr int ENEMY6_BASE_Y{ 332 };

constexpr int ENEMY7_BASE_X{ 900 };
constexpr int ENEMY7_BASE_Y{ 212 };

constexpr int ENEMY8_BASE_X{ 900 };
constexpr int ENEMY8_BASE_Y{ 100 };

constexpr int ENEMY9_BASE_X{ 900 };
constexpr int ENEMY9_BASE_Y{ 0 };

constexpr int ENEMY10_BASE_X{ 1100 };
constexpr int ENEMY10_BASE_Y{ 460 };
...
void Level6::update()
{
	...
	else if (mouse_pos->get_x() > ENEMY4_BASE_X && mouse_pos->get_x() < ENEMY4_BASE_X + 130 && mouse_pos->get_y() > ENEMY4_BASE_Y && mouse_pos->get_y() < ENEMY4_BASE_Y + 130 && Input_handle::instance()->get_mouse_state(LEFT) == true) {
		if (m_enemy[4] != nullptr) {
			m_player->set_position(ENEMY4_BASE_X + 31, ENEMY4_BASE_Y + 50);
	...
	else if (is_tower_destroyed(0, 4) && mouse_pos->get_x() > ENEMY5_BASE_X && mouse_pos->get_x() < ENEMY5_BASE_X + 130 && mouse_pos->get_y() > ENEMY5_BASE_Y && mouse_pos->get_y() < ENEMY5_BASE_Y + 130 && Input_handle::instance()->get_mouse_state(LEFT) == true) {
	...
	else if (is_tower_destroyed(0, 4) && mouse_pos->get_x() > ENEMY6_BASE_X && mouse_pos->get_x() < ENEMY6_BASE_X + 130 && mouse_pos->get_y() > ENEMY6_BASE_Y && mouse_pos->get_y() < ENEMY6_BASE_Y + 130 && Input_handle::instance()->get_mouse_state(LEFT) == true) {
	...
	else if (is_tower_destroyed(0, 4) && mouse_pos->get_x() > ENEMY7_BASE_X && mouse_pos->get_x() < ENEMY7_BASE_X + 130 && mouse_pos->get_y() > ENEMY7_BASE_Y && mouse_pos->get_y() < ENEMY7_BASE_Y + 130 && Input_handle::instance()->get_mouse_state(LEFT) == true) {
	...
	else if (is_tower_destroyed(0, 4) && mouse_pos->get_x() > ENEMY8_BASE_X && mouse_pos->get_x() < ENEMY8_BASE_X + 130 && mouse_pos->get_y() > ENEMY8_BASE_Y && mouse_pos->get_y() < ENEMY8_BASE_Y + 130 && Input_handle::instance()->get_mouse_state(LEFT) == true) {
		if (m_enemy[8] != nullptr) {
			m_player->set_position(ENEMY8_BASE_X + 31, ENEMY8_BASE_Y + 62);
	...
	else if (is_tower_destroyed(0, 4) && mouse_pos->get_x() > ENEMY9_BASE_X && mouse_pos->get_x() < ENEMY9_BASE_X + 130 && mouse_pos->get_y() > ENEMY9_BASE_Y && mouse_pos->get_y() < ENEMY9_BASE_Y + 130 && Input_handle::instance()->get_mouse_state(LEFT) == true) {
	...
	else if (is_tower_destroyed(0, 9) && mouse_pos->get_x() > ENEMY10_BASE_X && mouse_pos->get_x() < ENEMY10_BASE_X + 130 && mouse_pos->get_y() > ENEMY10_BASE_Y && mouse_pos->get_y() < ENEMY10_BASE_Y + 130 && Input_handle::instance()->get_mouse_state(LEFT) == true) {
		if (m_enemy[10] != nullptr) {
			m_player->set_position(ENEMY10_BASE_X + 31, ENEMY10_BASE_Y + 62);
...
bool Level6::on_start()
{
	...
	m_object.push_back(new Game_object("base"s, ENEMY3_BASE_X, ENEMY3_BASE_Y, 130, 130));//enemy3's base, tower 1
	m_object.push_back(new Game_object("roof"s, ENEMY4_BASE_X, ENEMY4_BASE_Y, 130, 130));//enemy4's base, tower 1
	...
	m_object.push_back(new Game_object("base"s, ENEMY8_BASE_X, ENEMY8_BASE_Y, 130, 130));//enemy8's base, tower 2
	m_object.push_back(new Game_object("roof"s, ENEMY9_BASE_X, ENEMY9_BASE_Y, 130, 130));//enemy9's base, tower 2
	m_object.push_back(new Game_object("roof"s, ENEMY10_BASE_X, ENEMY10_BASE_Y, 130, 130));//enemy10's base, tower 3
	...
	m_enemy.push_back(new Enemy("debuff"s, ENEMY4_STRENGTH, ENEMY4_BASE_X + 50, ENEMY4_BASE_Y + 72, 32, 32, SDL_FLIP_HORIZONTAL)); enemy_count++;//enemy4
	...
	m_enemy.push_back(new Enemy("enemy_default"s, ENEMY8_STRENGTH, ENEMY8_BASE_X + 50, ENEMY8_BASE_Y + 68, 80, 64, SDL_FLIP_HORIZONTAL)); enemy_count++;//enemy8
	m_enemy.push_back(new Enemy("enemy_default"s, ENEMY9_STRENGTH, ENEMY9_BASE_X + 50, ENEMY9_BASE_Y + 55, 80, 64, SDL_FLIP_HORIZONTAL)); enemy_count++;//enemy9
	m_enemy.push_back(new Enemy("enemy_default"s, ENEMY10_STRENGTH, ENEMY10_BASE_X + 50, ENEMY10_BASE_Y + 68, 80, 64, SDL_FLIP_HORIZONTAL)); enemy_count++;//enemy10
